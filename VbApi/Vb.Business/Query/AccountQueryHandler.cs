...
namespace Vb.Business.Query
{
        ...
        IRequestHandler<GetAccountByIdQuery, ApiResponse<AccountResponse>>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                return new ApiResponse<List<AccountResponse>>($"Error getting accounts: {ex.Message}");
            }
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                return new ApiResponse<AccountResponse>($"Error getting account by ID: {ex.Message}");
            }
        }
    }
}
